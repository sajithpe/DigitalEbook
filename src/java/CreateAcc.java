...
public class CreateAcc extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String p_un = request.getParameter("un1");
            ...
            try {
                ...
                ResultSet rs = db_connection.search("SELECT * FROM user WHERE user_email='" + p_em + "'");
             ...
             if("".equals(rs_mail)){
                ...
                db_connection.updater("INSERT INTO user(username,password,email,user_delt)"
                        + "VALUES('"+p_un+"','"+p_pw+"','"+p_em+"','0')");
