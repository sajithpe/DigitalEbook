 ...
 * @author SajithPe
 */
public class BkEditCheck extends HttpServlet {
...
//txtfield,combo,radio wage ekakda balanawa
                            ...
                            if (fileItem.getFieldName().equals("beimgn")) {
                            ...
                            File savedFile = new File(request.getServletContext().getRealPath("/") + "tmbs/" + fileName);
